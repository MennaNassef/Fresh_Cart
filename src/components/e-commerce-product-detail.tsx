            ...
            <div className="mt-8">
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={addToCart}
                  type="button"
                  className="flex-1 disabled:bg-indigo-300 bg-indigo-600 text-white py-3 px-6 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center justify-center gap-2"
                  disabled={IsLoading}
                >
                  {IsLoading?(
